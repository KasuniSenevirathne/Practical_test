...
public class DoctorsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String output = userObj.addDoctorDetails(request.getParameter("Rdoctor_name"), request.getParameter("Rdoctor_address"),
				request.getParameter("Rdoctor_specilaization"), request.getParameter("Rdoctor_email"));
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response)
		...
		// TODO Auto-generated method stub
		Map paras = getParasMap(request);
		 String output = userObj.deleteDoctors(paras.get("Rdoctor_ID").toString());
		response.getWriter().write(output);
	}
